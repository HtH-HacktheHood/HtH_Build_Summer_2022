...
cherbourg_survival = len( cherbourg_passengers[ cherbourg_passengers["Survival"] == 1 ] ) / len( cherbourg_passengers )
...
queenstown_survival = len( queenstown_passengers[ queenstown_passengers["Survival"] == 1 ] ) / len( queenstown_passengers )

# Step 10(c): Find the survival percentage of passengers in group "S"
south_passengers = titanic_data[ titanic_data['Embarked'] == 'S' ]
south_survival = len( south_passengers[ south_passengers["Survival"] == 1 ] ) / len( south_passengers )